...
class Search(commands.Cog):
    ...
    async def search(self):
        if config_dict["commands"]["search"] is True and config_dict["commands"]["state"] is True:
    ...
    async def on_message(self, message):
        if message.channel.id != self.bot.channel_id or config_dict["commands"]["state"] is False or config_dict["commands"]["search"] is False:
            return
