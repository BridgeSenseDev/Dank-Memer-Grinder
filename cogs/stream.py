...
Games = {"Apex Legends": 0, "COD Warzone": 1, "CS GO": 2, "Dead by Daylight": 3,
         "Destiny 2": 4, "Dota 2": 5, "Elden Ring": 6, "Escape from Tarkov": 7,
         "FIFA 22": 8, "Fortnite": 9, "Grand Theft Auto V": 10, "Hearthstone": 11, "Just Chatting": 12, "League of Legends": 13,
         "Lost Ark": 14, "Minecraft": 15, "Music": 16, "PUBG Battlegrounds": 17, "Rainbow Six Siege": 18,
         "Rocket League": 19, "Rust": 20, "Teamfight Tactics": 21, "Valorant": 22, "World of Tanks": 23, "World of Warcraft": 24, "World Of Warcraft": 24}
        ...
        for embed in message.embeds:
            ...
            try:
                if embed.to_dict()["fields"][1]["name"] == "Last Live":
                    ...
                    # Get trending game
                    async for cmd in self.bot.channel.slash_commands(command_ids=[967369106301026344]):
                        await cmd()
                        break
